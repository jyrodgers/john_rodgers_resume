...
\vspace{-1mm}
\begin{itemize}
	\item Engineered and owned \textbf{C++} library for managing \textbf{OpenSSL}-secured \textbf{DTLS} connections, including client/server roles and \textbf{multi-threading} for heartbeat monitoring and packet queuing.
