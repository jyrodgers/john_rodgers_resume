...
\begin{itemize}
	...
	\item Recovered data from failed Docker/\textbf{Kubernetes} containers by creating "black box" files, leveraging multiple threads, \textbf{circular buffers}, \textbf{IPC}-based communication, and remote \textbf{volume store}.
	\item \textbf{Streamed} monitoring/analysis data from Docker/Kubernetes \textbf{containers} with multi-client to server log/metric publishing microservice leveraging \textbf{gRPC}, \textbf{Fluent Bit}, \textbf{Kafka}, \textbf{Grafana} and \textbf{Splunk}.
	\item Optimized deployment process by regularly \textbf{deploying}, \textbf{debugging} and \textbf{administering} Linux-based VMs used to develop, test, and deploy Docker/Kubernetes containers.
