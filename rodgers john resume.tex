...
\begin{itemize}
	...
	\item Significantly reduced application suite build/test times by \textbf{>3 hours} through proposing, planning, and leading an intern project focused on process optimization and efficiency in a containerized build environment.
        ...
        \end{itemize}
	\item Boosted team velocity by 25\% over three-year tenure as \textbf{Scrum Master} for 8-member team by streamlining \textbf{JIRA} workflows, and fostering cross-team collaboration, while also excelling in primary developer role.
